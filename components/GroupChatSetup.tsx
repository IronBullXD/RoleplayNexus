  ...
  return (
    <div className="w-full h-screen bg-transparent flex flex-col">
      ...
      <main className="flex-1 overflow-y-auto p-6 md:p-8 space-y-8 max-w-4xl mx-auto w-full custom-scrollbar">
        <div>
          <h2 className="text-lg font-semibold text-slate-200 font-display tracking-wider">
          ...
          <div className="mt-4 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
            {selectableCharacters.map((char) => (
              ...
              >
                ...
                ></div>
                <p className="absolute bottom-2 left-2 right-2 text-sm font-bold text-white truncate">
                  {char.name}
                </p>
                {selectedIds.has(char.id) && (
        ...
        <div>
          ...
          <p className="text-sm text-slate-400 mt-1">
            Describe the setting or initial situation for the characters.
          </p>
          <textarea
            value={scenario}
